...
class Object():
    ...
    """
    def __init__(self, name: str, x: float, y: float, m: float) -> None:
    ...
    def __repr__(self) -> str:
        return str((self.getName(), self.getM(), self.getX(), self.getY()))
...
class Ball(Object):
    ...
    def getXVelocity(self) -> float:
        return self.getVelocity() * np.cos(self.getAngle())

    def getYVelocity(self) -> float:
        return self.getVelocity() * np.sin(self.getAngle())
